...
4. Переходим в создавшуюся директорию с именем soci (имя нашей установленной библиотеки). Для пехода используем команду cd.\ Выглядит это так: C:\Users\Сервис\source\repos>cd soci
